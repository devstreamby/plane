...
export class IssueTypeService extends APIService {
  ...
  async createIssueType(workspaceSlug: string, projectId: string, data: TIssueTypePayload): Promise<TIssueType> {
  ...
  async markAsDefault(workspaceSlug: string, projectId: string, issueTypeId: string): Promise<TIssueType> {
